        ...
        <div className="container">
            <div className="row justify-content-center mt-5">
                <div className="col-lg-7 col-10 col-sm-10 col-md-6 pr-0">
                    ...
                    Jestem Dietetykiem oraz Technikiem żywienia. Dietetyka jest mi bliska od niemal 10 lat. Przez te lata nieustannie poszerzam swoją wiedzę kończąc kolejne szkolenia, śledząc badania naukowe oraz zdobywając doświadczenie w pracy z pajetami.<br/>
